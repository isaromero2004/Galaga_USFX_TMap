...
#define UE_PROJECT_NAME Galaga_USFX_TMap
#define UE_TARGET_NAME Galaga_USFX_TMapEditor
#define UE_MODULE_NAME "Galaga_USFX_TMap"
...
#define GALAGA_USFX_TMAP_API DLLEXPORT
